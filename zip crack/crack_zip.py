...
parser.add_argument('--file', nargs='?', action="store", dest='file', help="The zip file to crack.")
parser.add_argument('--pwdfile', nargs='?', action="store", dest="pwdfile", help="The reference password file.")
