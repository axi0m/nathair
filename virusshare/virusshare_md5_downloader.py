...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="VirusShare MD5 Hash List Generator; all arguments are optional",
        usage="./virusshare_md5_downloader.py -o hash.txt",
    )
    # output argument
    parser.add_argument(
        "-o",
        "--output",
        help="Output file (optional, default=hash.txt)",
        default="./hash.txt",
    )
